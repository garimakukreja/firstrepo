{{ config(materialized="table", unique_key="integration_id") }}
     ...
     {#   {% do mkTruncate_stage_table() %}
        ...
        {% set src_tables = ['fact_ap_aging_a_stg', 'dim_supplier_stg', 'dim_gl_ledgers_stg', 'dim_legal_entity_stg', 'dim_gl_account_stg', 'dim_business_unit_stg', 'dim_org_stg'] %}
