{{ config(materialized="table", unique_key="integration_id") }}
        ...
        {% set src_tables = ['ct_ap_aging_a_stg', 'ct_supplier_d', 'ct_gl_ledgers_d', 'ct_legal_entity_d', 'ct_gl_account_d', 'ct_business_unit_d', 'ct_org_d'] %}
