...
select 
  ...
  '' as supplier_contact, 
  cledgers.name as ledger_name, 
  ap_invoices_all.invoice_id as invoice_id, 
  ap_invoices_all.invoice_num as invoice_num, 
  ap_invoices_all.description as invoice_desc, 
  ap_invoice_lines_all.line_number as invoice_line_num, 
  ap_invoice_distributions_all.distribution_line_number as dist_line_num, 
  ap_invoices_all.invoice_currency_code as inv_curr_code, 
  cledgers.currency_code as ledger_curr_code, 
  ap_invoices_all.payment_currency_code as payment_curr_code, 
  ap_invoices_all.invoice_date as invoice_dt, 
  ap_invoices_all.gl_date as gl_dt, 
  ap_invoice_distributions_all.accounting_date as accounting_dt, 
  orm.due_date as payment_due_dt, 
  '' as org_num, 
  '' as org_name, 
  '' as bu_num, 
  '' as bu_name, 
  ...
  '' as exp_segment8, 
  '' as exp_segment9, 
  ap_invoices_all.source as inv_source, 
  ap_invoices_all.invoice_type_lookup_code as inv_type_code, 
  ap_lookup_codes.displayed_field as inv_type_name, 
  '' as transaction_sub_type, 
  ap_terms_tl.name as payment_terms, 
  ...
  ap_invoices_all.exchange_rate as exch_rate, 
  ap_invoices_all.attribute_category as header_category_code, 
  ap_invoices_all.cancelled_date as cancelled_dt, 
  ap_invoices_all.cancelled_by as cancelled_by, 
  '' as project_name, 
  '' as task_name, 
  ...
  '-' as product_name, 
  '-' as product_desc, 
  po_line_locations_all.unit_meas_lookup_code as uom_code, 
  '-' as uom_desc, 
  ap_invoice_lines_all.cancelled_flag as line_cancelled_flag, 
  ap_invoice_distributions_all.type_1099 as type_1099, 
  '-' as line_category_code, 
  '-' as accrual_posted_flag, 
  '-' as cash_posted_flag, 
  '-' as dist_glcc_concat, 
  ap_invoice_distributions_all.posted_flag as posted_flag, 
  '-' as dist_category_code, 
  po_headers_all.po_header_id as po_header_id, 
  po_headers_all.segment1 as po_number, 
  po_lines_all.po_line_id as po_line_id, 
  po_lines_all.line_num as po_line_num, 
  po_line_locations_all.line_location_id as po_line_location_id, 
  '-' as po_shipment_num, 
  ap_invoice_distributions_all.po_distribution_id as po_distribution_id, 
  ...
  0 as inv_dist_line_amount_usd, 
  0 as inv_ledger_amount_usd, 
  0 as paid_amount_usd, 
  0 as remaining_due_amount_usd, 
  0 as conv_rate_to_usd, 
  '' as conv_rate_type, 
  ap_invoices_all.creation_date as creation_dt, 
